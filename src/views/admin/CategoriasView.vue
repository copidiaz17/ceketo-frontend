  ...
  <div class="p-8">
    <div class="mb-8 flex items-center justify-between">
      <div>
        ...
        <p class="font-body text-gray-500 mt-1">Agrupaciones de productos</p>
      </div>
      <button
      ...
      <table class="w-full font-body text-sm">
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-6 py-4 text-gray-900">{{ c.nombre }}</td>
          ...
          <tr v-if="categorias.length === 0">
            <td colspan="3" class="px-6 py-10 text-center text-gray-400">Sin categorías</td>
          </tr>
        </tbody>
      </table>
    </div>
        ...
        <div class="space-y-4">
          <div>
            ...
            <input v-model="modal.form.codigo" type="text" placeholder="BYM"
              class="w-full px-4 py-2.5 rounded-xl bg-gray-50 border border-gray-200 text-gray-800 font-mono text-sm uppercase focus:outline-none focus:border-teal transition-colors" />
          </div>
          <div>
    ...
    <div v-if="eliminarModal.abierto" class="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
      <div class="bg-white border border-red-500/30 rounded-2xl p-8 w-full max-w-sm text-center">
        ...
        <h2 class="font-display text-xl font-bold text-gray-900 mb-2">Eliminar categoría</h2>
        <p class="font-body text-gray-900 font-semibold mb-2">{{ eliminarModal.cat?.nombre }}</p>
